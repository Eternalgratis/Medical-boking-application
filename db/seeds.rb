...
5.times do
    Qualification.create!(
        ...
        procurement_year: Faker::Number.between(from: 1980, to: 2022) 
    )
end
...
10.times do
    OfficeDoctorAvailability.create!(
        office_id: rand(1..10),
        day_of_week: Faker::Date::DAYNAMES.sample,
...
5.times do
    InNetworkInsurance.create!(
        insurance_name: rand(1..10),
        office_id: Faker::Insurance.company
    )
end
